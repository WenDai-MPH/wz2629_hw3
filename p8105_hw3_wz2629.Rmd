...
#### Comment:
The final combined dataframe named "combine_df" have `r nrow(combine_df)` observations and `r ncol(combine_df)` variables, which include all originially ovserved variables and exclude participants less than 21 years of age and those of missing demographic data. Also, we organized the education as a factor taking levels ordered from "Less than high school" to "More than high school" by using fct_relevel().
